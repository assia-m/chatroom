...
public class Client  {
	...
	static ChatRoom cgui; // CLIENT GUI VARIABLE (THIS WILL BE THE GROUP CHAT ROOM WHEN OPENED)
	static String host; // HOST VARIABLE
	String username; // USERNAME VARIABLE (NOT WORKING HOW IT SHOULD)
	static int port; // PORT VARIABLE

	Client(String server, int p, String user, ChatRoom cg) { // CONSTRUCTOR WHICH NEEDS TO BE PASSED THE SERVER NAME, PORT NUMBER, USERNAME, CHAT ROOM GUI
	...
	public boolean start() { // STARTS WHEN CONNECTION IS ALIVE (WHICH IS WHY ITS BOOLEAN)
		...
		String msg = "Connection sucessful to server host " + getHost() + " on port " + getPort(); // MESSAGE TO CLIENT SAYING THEY HAVE CONNECTED TO SERVER
	...
	public static void main(String[] args) {
		Client client = new Client(host, port, null, cgui); // STARTS CLIENT WITH GIVEN VARIABLES

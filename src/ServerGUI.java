...
public class ServerGUI extends JFrame implements ActionListener {
	...
	ServerGUI() {
		...
		chatLog = new JTextArea(80,80);
		chatLog.setEditable(false);
		appendRoom("Chat Room Log:\n");
	...
	public static void appendRoom(String str) { // EDITS CHAT LOG ON SERVER GUI
		chatLog.append(str);
	...
	public static void appendEvent(String str) { // EDITS EVENT LOG ON SERVER GUI
		...
		eventUpdate.setCaretPosition(chatLog.getText().length() - 1);
